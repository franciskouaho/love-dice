...
export default function HomeScreen() {
  ...
  // Fonction appelée lors d'une secousse du téléphone
  ...
  const { isShaking } = useShake({
    threshold: 2.0, // Seuil de détection moins sensible pour éviter les faux positifs
    timeWindow: 1500, // Délai entre les secousses pour éviter les lancers multiples
    onShake: handleShake
  });
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.bottomControls}>
        ...
        <View style={{ alignItems: 'center' }}>
          ...
          {/* Indication de secousse */}
          <Animated.View 
            style={{
              marginTop: 8,
              opacity: isShaking ? 0.3 : 0.7,
              transform: [{ scale: isShaking ? 1.1 : 1 }],
            }}
          >
            <Text style={{
