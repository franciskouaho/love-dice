...
export const RealDice3D: React.FC<RealDice3DProps> = ({ 
  ...
  // Positions corrigées pour les dés 3D (avec espace pour les faces latérales)
  const positions = [
    { left: width * 0.1, top: insets.top + 100 },
    { left: width * 0.5, top: insets.top + 120 },
    { left: width * 0.3, top: insets.top + 260 },
  ];
  ...
  return (
    <View style={[styles.container, { backgroundColor: 'rgba(255,0,0,0.1)' }]}>
      <Text style={{ color: 'white', position: 'absolute', top: 10, left: 10, zIndex: 1000 }}>
        🎲 Dés: {diceData.length}
      </Text>
