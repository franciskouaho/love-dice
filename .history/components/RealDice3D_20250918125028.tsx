...
export const RealDice3D: React.FC<RealDice3DProps> = ({ 
  ...
  // Positions garanties visibles - tous dans le cadre
  const positions = [
    { left: 50, top: 250 },   // Dé 1 : gauche, plus bas
    { left: 170, top: 200 },  // Dé 2 : centre, plus haut
    { left: 110, top: 400 },  // Dé 3 : bas centre, plus vers la gauche
  ];
