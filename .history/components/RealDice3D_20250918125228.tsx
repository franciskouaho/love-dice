...
export const RealDice3D: React.FC<RealDice3DProps> = ({ 
  ...
  // Positions vraiment centrées sur l'écran
  const screenCenter = width / 2; // 402/2 = 201
  const diceHalfSize = DICE_SIZE / 2; // 80/2 = 40
  
  const positions = [
    { left: screenCenter - 80, top: 320 },   // Dé 1 : gauche du centre (201-80=121)
    { left: screenCenter + 40, top: 320 },   // Dé 2 : droite du centre (201+40=241)
    { left: screenCenter - 20, top: 450 },   // Dé 3 : bas centre (201-20=181)
  ];
