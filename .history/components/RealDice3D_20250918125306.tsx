...
export const RealDice3D: React.FC<RealDice3DProps> = ({ 
  ...
  const positions = [
    { left: screenCenter - 120, top: 320 },   // Dé 1 : plus à gauche (201-120=81)
    { left: screenCenter - 40, top: 320 },    // Dé 2 : légèrement à gauche (201-40=161)
    { left: screenCenter - 80, top: 450 },    // Dé 3 : centré en bas (201-80=121)
  ];
