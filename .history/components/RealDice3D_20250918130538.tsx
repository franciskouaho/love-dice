...
export const RealDice3D: React.FC<RealDice3DProps> = ({ 
  ...
  const positions = [
    { left: screenCenter - 220, top: 10 },   // Dé 1 : plus à gauche (201-120=81)
    { left: screenCenter - 350, top: 220 },    // Dé 2 : légèrement à gauche (201-40=161)
    { left: screenCenter - 125, top: 220 },    // Dé 3 : centré en bas (201-80=121)
  ];
      ...
      {diceData.map((dice, index) => (
        <View
          ...
          style={{
            ...
            width: DICE_SIZE + 12, // Plus large pour les faces latérales
            height: DICE_SIZE + 12, // Plus haut pour les faces latérales
          }}
        >
          {/* Ombre du dé */}
          <View 
          ...
          {/* Dé 3D avec 3 faces visibles */}
          <View style={{ position: 'relative', width: DICE_SIZE, height: DICE_SIZE }}>
            ...
            {/* Face droite (perspective isométrique) */}
            <View
              style={{
                position: 'absolute',
                width: 20,
            ...
            >
              {/* Pattern de points sur la face droite */}
            ...
            {/* Face du haut (perspective isométrique) */}
            <View
              style={{
                position: 'absolute',
                width: DICE_SIZE,
            ...
            >
              {/* Pattern de points sur la face du haut */}
