...
export const ThreeDiceResult: React.FC<ThreeDiceResultProps> = ({ 
  ...
  // Générer des positions aléatoires mais sécurisées (version simple)
  const getRandomPositions = () => {
    const margin = 60; // Marge sécurisée
    const minLeft = margin;
    const maxLeft = width - DICE_SIZE - margin;
    const minTop = 100; // Zone haute sécurisée  
    const maxTop = 250; // Zone centrale
