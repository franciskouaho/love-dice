...
export const ThreeDiceResult: React.FC<ThreeDiceResultProps> = ({
  ...
  // positions sûres et non chevauchantes; régénérées si taille/insets changent
  const randomPositions = useMemo(() => {
    return generateNonOverlappingPositions(3, containerSize.w, containerSize.h, insets, diceSize);
  }, [
    containerSize.w,
    containerSize.h,
    insets.top,
