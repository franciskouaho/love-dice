...
export const ThreeDiceResult: React.FC<ThreeDiceResultProps> = ({
  ...
  const randomPositions = useMemo(() => {
    ...
    const minTop = insets.top + 50; // Éviter le notch
    const maxTop = containerHeight - diceSize - 80; // Éviter le bas
    
    const positions: { left: number; top: number }[] = [];
    const minDistance = diceSize + 25; // Distance minimum entre dés
